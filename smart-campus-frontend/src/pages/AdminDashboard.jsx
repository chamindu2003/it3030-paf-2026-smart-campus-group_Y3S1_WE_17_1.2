  ...
  return (
    <div className="admin-dashboard-page">
      <div className="admin-layout">
        <AdminPortalSidebar
          activeItem={isUsersPage ? 'users' : isOverviewPage ? 'overview' : ''}
          bookingsCount={metricsLoading ? '...' : metrics.bookingsToday}
          ticketsCount={metricsLoading ? '...' : metrics.openTickets}
          usersCount={metricsLoading ? '...' : metrics.totalUsers}
          displayName={profile?.name || user?.name || 'Admin User'}
