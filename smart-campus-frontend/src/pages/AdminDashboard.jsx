      ...
      <div className="admin-dashboard-page">
        <div className="admin-dashboard-shell">
          <section className="admin-access-card">
            ...
            <p>This area is only available for admin accounts.</p>
      ...
      <div className="admin-layout">
        <aside className="admin-sidebar">
              ...
              <ul className="admin-sidebar-list">
                ...
                <li>
                  <button type="button" className="admin-sidebar-item" onClick={goToOverview}>
                    ...
                    <span>Bookings</span>
                    <span className="admin-sidebar-count">{metricsLoading ? '...' : metrics.bookingsToday}</span>
                  </button>
                </li>
                <li>
                  <button type="button" className="admin-sidebar-item" onClick={goToOverview}>
                    ...
                    <span>Tickets</span>
                    <span className="admin-sidebar-count">{metricsLoading ? '...' : metrics.openTickets}</span>
                  </button>
                </li>
                <li>
                  <button type="button" className="admin-sidebar-item" onClick={goToOverview}>
          ...
          <div className="admin-sidebar-profile">
            ...
            <div>
              <p className="admin-profile-name">{profile?.name || user?.name || 'Admin User'}</p>
              <p className="admin-profile-email">{profile?.email || user?.email || 'admin@example.com'}</p>
            </div>
          </div>
        </aside>
            ...
            <>
              ...
              <section className="admin-quick-actions">
                ...
                <div className="admin-quick-grid">
                  ...
                  <button type="button" className="admin-quick-card" onClick={() => setNotificationOpen(true)}>
                    <span className="admin-quick-icon" aria-hidden="true">
                      <svg viewBox="0 0 24 24" fill="none">
                        <path d="m5 18 4.8-4.8a3.3 3.3 0 0 1 4.6 0l.4.4a3.3 3.3 0 0 1 0 4.6L10 23" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
                        <path d="m14 10 4.8-4.8a3.3 3.3 0 0 1 4.6 0l.4.4a3.3 3.3 0 0 1 0 4.6L19 15" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" transform="translate(-5 -5)" />
