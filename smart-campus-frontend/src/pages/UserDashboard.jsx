            ...
            <div className="userdash-sidebar-top">
              ...
              <nav aria-label="User sidebar navigation">
                <ul className="userdash-sidebar-list">
                  <li>
                    <button type="button" className="userdash-sidebar-item is-active" onClick={() => navigate('/dashboard')}>
                  ...
                  {/* 1. NEW: Report Incident Button */}
                  <li>
                    <button type="button" className="userdash-sidebar-item" onClick={() => navigate('/report')}>
                    <span className="userdash-sidebar-icon" aria-hidden="true">
                      <svg viewBox="0 0 24 24" fill="none">
                        <path d="M12 4v16m8-8H4" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
                      </svg>
                    </span>
                  ...
                  {/* 2. FIXED: Tickets Button (Now routes to /tickets) */}
                  <li>
                    <button type="button" className="userdash-sidebar-item" onClick={() => navigate('/tickets')}>
                    <span className="userdash-sidebar-icon" aria-hidden="true">
                      <svg viewBox="0 0 24 24" fill="none">
